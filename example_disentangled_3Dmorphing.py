...
for idx in range(len(src_img_path_list)):
    ...
    morphing_params = {"morphing_num": 50, "src_load_cache_path": src_save_cache_path, "tar_load_cache_path": tar_save_cache_path, "init_morphing_flag": False, "ss_mca_flag": True, "slat_mca_flag": False, "ss_tfsa_flag": True, "slat_tfsa_flag": False, "oc_flag": False}
    save_path = os.path.join(save_dir_path, "disentangled_structure_3Dmorphing", name)
    ...
    save_path = os.path.join(save_dir_path, "disentangled_detail_3Dmorphing", name)
    os.makedirs(save_path, exist_ok=True)
    save_cache_path = os.path.join(save_path, "cache")
    os.makedirs(save_cache_path, exist_ok=True)
    morphing_params["save_cache_path"] = save_cache_path
